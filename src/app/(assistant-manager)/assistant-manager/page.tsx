  ...
  return (
    <div className="flex h-[100dvh] bg-surface dark:bg-surface-dark overflow-hidden">
      ...
      <ResponsiveSidebar open={sidebarOpen} onClose={() => setSidebarOpen(false)} width={260}>
        ...
        <div className="px-4 py-3 border-b border-line dark:border-line-dark shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-content-secondary dark:text-content-dark-secondary truncate flex items-center gap-1">
                <ShieldCheck className="w-3 h-3" /> Asst. Service Manager
              </p>
            </div>
          </div>
        </div>
              ...
              <button key={nav.key} onClick={() => { setPageView(nav.key); if (isMobile) setSidebarOpen(false); }}
                ...
                {nav.count !== undefined && (
                  <span className={cn(
                    ...
                    pageView === nav.key ? "bg-white/20 text-white" : "bg-surface-secondary dark:bg-surface-dark-secondary text-content-tertiary dark:text-content-dark-tertiary"
                  )}>{nav.count}</span>
                )}
              </button>
            ))}
        ...
        <div className="px-4 py-3 border-t border-line dark:border-line-dark shrink-0">
          <button onClick={handleLogout}
            className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-content-secondary dark:text-content-dark-secondary hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors">
