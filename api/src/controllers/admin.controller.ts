  ...
  try {
    ...
    const result = customers.map(customer => {
      ...
      return {
        ...
        address: meta.regAddress || meta.manualAddress || null,
        pincode: meta.regPincode || meta.manualPincode || null,
        place: meta.regPlace || meta.manualPlace || null,
        district: meta.regDistrict || meta.manualDistrict || null,
        state: meta.regState || meta.manualState || null,
        googleMapLink: meta.regGmapLink || meta.manualGmapLink || null,
