...
export const SETTING_DEFINITIONS: SettingDefinition[] = [
  ...
  },
  {
    ...
    description: "Google Business review dialog URL sent to customers rating service 3 or more stars.",
    category: "whatsapp",
    isSecret: false,
    defaultValue:
...
export const runtime = {
  ...
  googleReviewUrl: () => cfg("GOOGLE_REVIEW_URL") || env.GOOGLE_REVIEW_URL,
};
