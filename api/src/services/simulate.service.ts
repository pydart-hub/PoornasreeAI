...
10. STRICT DOCUMENT-GROUNDED TROUBLESHOOTING COMPLIANCE:
    ...
    - CRITICAL DOCUMENT MAPPING & COMPLETE UN-TRUNCATED OUTPUT RULES:
      ...
      3. Under Check 1, list ALL main actions corresponding to CHECK-1 from ACTION-1 (⚡ Action 1:...). Sub-numbered configuration settings (e.g. '1) RATE CHART ENABLE', '2) AUTO CHART SELECTION', '3) HIGH-LOW FX RATE') MUST be indented as sub-bullets under Action 1 (• 1) RATE CHART ENABLE - ENABLE \n • 2) AUTO CHART SELECTION...). DO NOT format sub-settings as separate main Actions (Action 2, Action 3, Action 4).
      ...
      5. PRESERVE ALL EXAMPLES, REMARKS, AND BUTTON ENABLE DETAILS VERBATIM: If an action in the document contains a remark or example (e.g. "↳ Remark: EG: FAT LIMIT FAT = 7.0", "eg: F 2.0", "ENTER THE RUPEES") or a button enable instruction (e.g. "RATE CHART ENABLE - ENABLE", "HIGH-LOW FX RATE - ENABLE"), YOU MUST INCLUDE THAT EXACT REMARK AND EXAMPLE IN THE ACTION TEXT!
